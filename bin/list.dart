/// List di Dart
/// List di Dart adalah sebuah koleksi yang berisi sekumpulan objek yang tersusun secara berurutan.
/// List di Dart mirip dengan array di bahasa pemrograman lainnya.
/// List di Dart memiliki beberapa method yang bisa digunakan untuk memanipulasi elemen-elemennya.
...
void main(List<String> arguments) {
  ...
  var languages = List<String>.filled(4, ''); // fixed-length list with 4 index and default value is empty value with type data string only
  ...
  // example list with growable list
  var platforms = ['Android', 'iOS', 'Windows', 'Linux', 'MacOS']; // growable list
  var os = List.from(platforms); // growable list from platforms
  print(os); // print os

  print(''); // print new line

  // example list with growable list
  var emptyList = []; // growable list
  print(emptyList); // print emptyList
